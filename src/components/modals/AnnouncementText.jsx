  ...
  render() {
    return(
      <div>
        ...
        <p>
          We call this system Sai (contraction of Simple Dai). It is a very basic decentralized stablecoin design that is soft-pegged to 1 USD and backed by ETH as collateral. You can read about it in more detail here: <a href="https://blog.makerdao.com/2017/06/05/introducing-sai/" target="_blank" rel="noopener noreferrer">https://blog.makerdao.com/2017/06/05/introducing-sai/</a>.
        </p>
        <p>
        ...
        <p>
          Mecon is also providing a distributed set of price feed oracles that Sai requires to function.
        </p>
        <p>
        ...
        <p>
          The most important data point to understand is the Liquidation Ratio of 150% and the Liquidation Penalty of 20%. This means that a Sai CDP user must hold his collateral-to-debt ratio above 150% at all times. If the collateral-to-debt ratio of a CDP falls below 150%, it becomes vulnerable to liquidation. If liquidation is triggered, the outstanding debt of the CDP increases by 20%, and the CDP is then settled based on the price feed.
        </p>
        <p>
          This Sai instance is just the first of many deployments. There will be continuous iteration on the Sai design and upgrades will be enforced by globally settling prior deployments. If a Sai instance hits its debt ceiling, it may also be necessary to globally settle it. The debt ceiling of the first Sai instance is at 5 million USD, an amount low enough to ensure that it will mainly be considered a livenet experiment for use within the Maker community, not a product release.
        </p>
        <p>
        ...
        <ul>
          ...
          <li>
            MKR control of Sai risk parameters through prism voting (A mechanism similar to Delegated Proof of Stake used by BitShares, Steemit and EOS)
          </li>
          <li>
        ...
        <p>
          If you have any questions, comments or concerns please join us at <a href="https://chat.makerdao.com/" target="_blank" rel="noopener noreferrer">chat.makerdao.com</a> channel #sai-stablecoin-system to assist in the development of Sai.
        </p>
      </div>
    )
  }
