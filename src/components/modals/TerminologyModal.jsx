      ...
      <div id="termsWrapper">
        ...
        <div className="content">
          <div>
            ...
            <strong>Boom:</strong> Buy DAI with SKR<br />
            <strong>Bust:</strong> Buy SKR with DAI<br />
            ...
            <strong>SKR:</strong> The token used as collateral in CDPs which represents a claim on the ETH collateral pool of the Dai Stablecoin System<br />
            ...
            <strong>Spread (boom/bust):</strong> Discount/premium relative to Dai target price at which the system buys/sells collateral SKR for DAI. When negative, collateral is being sold at a discount (under ‘bust’) and bought at a premium (under ‘boom’)<br />
